...
const SignUp: React.FC = () => {
  ...
  const handleSignUp = useCallback(async (data: SignupFormData) => {
    try {
      ...
      Alert.alert('Everything looks good!', 'You can now access your account');
      ...
      Alert.alert('SignUp error!', 'There was an error creating your account, please try again later');
    }
  }, [navigation]);
  return (
    <>
